...
function Input_Digit(digit) {
    ...
    //This checks if the Wait_Second_Operand is true and sets Dsiplay_Value
...
function Handle_Operator(Next_Operator) {
    ...
    if (First_Operand == null) {
        ...
        //This will remove any trialing 0's
...
function Update_Display() {
    ...
    const disply = document.querySelector('.calculator-screen');
    disply.value = Calculator.Display_Value;
}
