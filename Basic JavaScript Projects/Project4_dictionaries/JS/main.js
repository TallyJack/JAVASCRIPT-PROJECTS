...
function hero_traits() {
    ...
    document.getElementById("Dictionary").innerHTML = Invincible.realName;
}

//This a leftover stockpile of math functions from the previous function that I may wish to resuse at some point.
