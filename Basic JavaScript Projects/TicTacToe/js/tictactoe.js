...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'O') {
            ...
            disableClick();
            //This function waits 1 second before the computer places an image and enales click.
...
//This function takes a string parameter of the path youset earlier for
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    //This line accesses our HMTL canvas element.
    ...
    function animateLineDrawing() {
        ...
        if (x1 <= x2 && y1 <= y2) {
            ...
            if (x >= x2 && y >= y2) { cancelAnimationFrame(animateLineDrawing); }
        }
        //This condition is simialar to the one above.
